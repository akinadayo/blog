...
const interests = [
  ['01', 'つくる', 'モバイルアプリやWebを、アイデアから動くものへ。'],
  ['02', '試す', '電子工作と3Dモデリング。手を動かして理解する。'],
  ['03', '書く', '成功も失敗も、次の誰かのショートカットにする。'],
];
    ...
    <div className="about-page">
      <section className="about-hero">
        ...
        <motion.div className="profile-card" initial={{ opacity: 0, rotate: 3, y: 30 }} animate={{ opacity: 1, rotate: -2, y: 0 }}>
          <div className="profile-card__top"><span>プロフィールカード</span><span>LV.28</span></div>
      ...
      <section className="about-story">
        ...
        <div className="about-story__grid">
          ...
          <div className="skill-board">
            <span className="skill-board__title">できること</span>
